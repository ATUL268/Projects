...
# api_k = "2qrcn5fc71cat3ck"  # api_key
# api_s = "lccnr6mjbd20zdx8aicosfrvvhror7zw"  # api_secret
# filename = str(datetime.datetime.now().date()) + ' token' + '.txt'

api_k = "r81dswd7wjaxauji"  # api_key
api_s = "g1etr1r17qy7xrg85eo0salfj3coy9lz"  # api_secret
filename = str(datetime.datetime.now().date()) + ' token' + '.txt'

# api_k = "e9y3nmbhx62uy8mt"  # api_key
# api_s = "unxias8lrgx47uk7izdr4v5jcl28gokd"  # api_secret
# filename = str(datetime.datetime.now().date()) + ' token' + '.txt'
